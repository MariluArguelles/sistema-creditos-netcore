...
namespace POS.Application.ExportPDF.Reportes
{
    public class Factura : IReport
    {
        ...
        //                row.ConstantItem(100).Image("../POS.Application/ExportPDF/Report/logo.png");
        ...
        //                    col.Item().AlignCenter().Text("maludeveloper@gmail.com").FontSize(9);
        //                });
        ...
        //                    // foreach (var item in dtSaleItems.Rows)
            ...
            Document document = Document.Create(contenedor =>
            {
                ...
                contenedor.Page(page =>
                {
                    ...
                    page.Header().ShowOnce().Row(row =>
                    {
                        //  row.ConstantItem(140).Height(60).Placeholder();
                        //row.ConstantItem(100).Image("../POS.Application/ExportPDF/Report/logo.png");
                        row.ConstantItem(100).Image("../Images/ExportPDF/Report/logo.png");
